...
func main() {
	...
	retryErr := retry.RetryOnConflict(retry.DefaultRetry, func() error {
		...
		currentPod, updateErr := podsClient.Get(context.TODO(), "go-crud-gmfwj", metav1.GetOptions{})
		if updateErr != nil {
	...
	// delete a pod
	deleteErr := podsClient.Delete(context.TODO(), "go-crud-gmfwj", metav1.DeleteOptions{})
	if deleteErr != nil {
